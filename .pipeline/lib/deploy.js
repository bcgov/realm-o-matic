...
module.exports = (settings)=>{
  ...
  objects = objects.concat(oc.processDeploymentTemplate(`${templatesLocalBaseUrl}/api-dc.yaml`, {
    param: {
  ...
  objects = objects.concat(oc.processDeploymentTemplate(`${templatesLocalBaseUrl}/web-dc.yaml`, {
    param: {
